...
export const vipFlowApps: VipTool[] = [
...
export const vipAiStudioApps: VipTool[] = [
...
export const vipWebApps: VipTool[] = [
...
export type VipPrompt = { title: string; content: string };
export type VipPromptGroup = { group: string; prompts: VipPrompt[] };

export const vipPromptGroups: VipPromptGroup[] = [
  {
    group: "Bán hàng",
    prompts: [
      {
...
/** Hướng dẫn kỹ thuật viết prompt Veo 3.1 — tài liệu bonus đi kèm gói VIP. */
export const veo31Guide = `1. Công thức viết Prompt hiệu quả
...
export const vipToolsCount =
  vipFlowApps.length + vipAiStudioApps.length + vipWebApps.length;

export const vipPromptsCount = vipPromptGroups.reduce(
